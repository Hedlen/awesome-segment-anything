...
- 2024.8.16: Added Segment Anything 2 (SAM 2) and SaLIP - First unified model for real-time object segmentation in images and videos.
- 2023.8.29: Updated with recent works and expanded derivative papers section.
- 2023.5.20: Updated document structure and added robotics-related article. Happy 520 Day!
- 2023.5.4: Added SEEM - Segment Everything Everywhere All at Once.
- 2023.4.18: Added Inpainting Anything and SAM-Track for video segmentation.
- 2023.4.12: Initial release tracking SAM papers and projects.
...
| Segment Anything 2 (SAM 2)                       | ![img](https://github.com/facebookresearch/segment-anything-2/blob/main/assets/model_diagram.png?raw=true)                                                                                              | [Paper](https://ai.meta.com/sam2/)            | [Project Page](https://ai.meta.com/sam2/)                                                                                                                                                                                     | [Code](https://github.com/facebookresearch/segment-anything-2)                      | Meta        | A foundation model towards solving promptable visual segmentation in images and videos.                   |
| SAM 3                                            | -                                                                                                                                                                                                       | [arXiv](https://arxiv.org/abs/2511.16719)     | [Project Page](https://huggingface.co/papers/2511.16719)                                                                                                                                                                      | -                                                                                   | Meta        | Segment Anything with Concepts: doubles accuracy on promptable concept segmentation in images and videos. |
...
| Segment Anything in High Quality | ![img](./imgs/HQ-SAM.png) | [NeurIPS2023](https://arxiv.org/pdf/2306.01567.pdf) | [Project Page](https://huggingface.co/papers/2306.01567) | [Code](https://github.com/SysCV/sam-hq) | ETH Zürich & HKUST | HQ-SAM: improve segmentation quality of SAM using learnable High-Quality Output Token. |
...
| EfficientSAM | ![img](https://github.com/yformer/EfficientSAM/raw/main/figs/efficient_sam_framework.png) | [CVPR2024](https://arxiv.org/abs/2312.00863) | [Project Page](https://huggingface.co/papers/2312.00863) | [Code](https://github.com/yformer/EfficientSAM) | Meta | Lightweight SAM models via masked image pretraining (SAMI), achieving competitive performance with greatly reduced complexity. |
| EdgeSAM | ![img](https://github.com/chongzhou96/EdgeSAM/raw/master/assets/teaser.png) | [arXiv](https://arxiv.org/abs/2312.06660) | [Project Page](https://mmlab-ntu.com/project/edgesam/) | [Code](https://github.com/chongzhou96/EdgeSAM) | MMLab@NTU | Prompt-in-the-loop distillation for on-device SAM deployment; 40× faster than SAM, first to run >30 FPS on iPhone 14. |
| Semantic-SAM | ![img](https://github.com/UX-Decoder/Semantic-SAM/raw/main/assets/teaser.png) | [arXiv](https://arxiv.org/abs/2307.04767) | [Project Page](https://huggingface.co/papers/2307.04767) | [Code](https://github.com/UX-Decoder/Semantic-SAM) | Microsoft | Universal image segmentation model that segments and recognizes anything at any desired granularity. |
| RankSEG | ![img](https://github.com/rankseg/rankseg/raw/main/fig/example1.jpeg) | [NeurIPS 2025](https://openreview.net/forum?id=4tRMm1JJhw) / [JMLR 2023](https://jmlr.org/papers/v24/22-0712.html) | [Docs](https://rankseg.readthedocs.io/en/latest/) / [Demo](https://huggingface.co/spaces/statmlben/rankseg) | [Code](https://github.com/rankseg/rankseg) / [Colab](https://colab.research.google.com/drive/1Gj-rG3ZnFN5OYTcgdJHfUuiSJtWVpgfu?usp=sharing) | CUHK | **RankSEG** is a **plug-and-play** post-processing module that improves segmentation results during inference. It works with segmentation models (SAM, DeepLab, SegFormer, UPerNet, etc.) without any retraining or fine-tuning. |
...
| SaLIP | - | [arXiv](https://arxiv.org/abs/2404.06362) | - | [Code](https://github.com/aleemsidra/SaLIP) | - | Test-Time Adaptation with SaLIP: A Cascade of SAM and CLIP for Zero-shot Medical Image Segmentation. |
| MedSAM-2 | - | [arXiv](https://arxiv.org/abs/2408.00874) | - | [Code](https://github.com/MedSAM2/MedSAM2) | - | Medical SAM 2: treats all 2D and 3D medical segmentation tasks as video object tracking, enabling universal auto-tracking segmentation. |
| SurgicalSAM | ![img](https://github.com/wenxi-yue/SurgicalSAM/raw/main/assets/framework.png) | [AAAI2024](https://arxiv.org/abs/2308.08746) | - | [Code](https://github.com/wenxi-yue/SurgicalSAM) | University of Adelaide | Efficient class-promptable surgical instrument segmentation by fine-tuning SAM with surgical-specific information, eliminating the need for explicit point/box prompts. |
...
| SAM-Road: Segment Anything Model for Road Network Graph Extraction | ![img](./imgs/sam_road_cover.png) | [arXiv](http://arxiv.org/abs/2403.16051) | - | [Code](https://github.com/htcr/sam_road) | Carnegie Mellon University | A simple and fast method applying SAM for vectorized large-scale road network graph extraction. It reaches state-of-the-art accuracy while being 40 times faster. |

#### Tracking
| Title | Presentation| Paper page | Project page | Code base | Affiliation| Description|
|:---:|:---:|:---:|:---:| :---:| :---:|:---:|
| Follow Anything | ![img1](./imgs/Follow-Anything.png) | [arXiv](https://arxiv.org/abs/2308.05737) | [Page](https://huggingface.co/papers/2308.05737) | [Code](https://github.com/alaamaalouf/FollowAnything) | MIT, Harvard University | An open-vocabulary and multimodal model to detect, track, and follow any objects in real-time.|
| Track-Anything | [Video](https://github.com/gaomingqi/Track-Anything/raw/master/assets/avengers.gif) | [arXiv](https://arxiv.org/abs/2304.11968) | - | [Code](https://github.com/gaomingqi/Track-Anything) | - | An interactive video object tracking and segmentation tool based on SAM and XMem.|
| SAM-Track | [Video](https://camo.githubusercontent.) | [arXiv](https://arxiv.org/abs/2305.06558) | - | [Code](https://github.com/z-x-yang/Segment-and-Track-Anything) | Zhejiang University | A framework called Segment And Track Anything (SAMTrack) that allows users to precisely and effectively segment and track any object in a video.|
...
| Title | Presentation                                                                  | Paper page                                   | Project page                                             | Code base                                       | Affiliation | Description                                                                                                                                               |
| :-----:| :-----------------------------------------------------------------------------:| :--------------------------------------------:| :--------------------------------------------------------:| :-----------------------------------------------:| :-----------:| :---------------------------------------------------------------------------------------------------------------------------------------------------------:|
| LISA  | ![img](https://github.com/JIA-Lab-research/LISA/blob/main/imgs/teaser.jpg)    | [CVPR2024](https://arxiv.org/abs/2308.00692) | [Project Page](https://huggingface.co/papers/2308.00692) | [Code](https://github.com/dvlab-research/LISA)  | CUHK        | Large Language Instructed Segmentation Assistant: inherits LLM language generation while producing segmentation masks from complex implicit text queries. |
| Sa2VA | ![img](https://github.com/bytedance/Sa2VA/blob/main/assets/images/teaser.jpg) | [arXiv](https://arxiv.org/abs/2501.04001)    | [Project Page](https://huggingface.co/papers/2501.04001) | [Code](https://github.com/magic-research/Sa2VA) | -           | Marries SAM 2 with LLaVA for dense grounded understanding of images and videos; unifies text, image, and video into a shared LLM token space.             |
...
| SAM web UI                       | ![img](https://github.com/Kingfish404/segment-anything-webui/raw/main/assets/demo.gif)                                                             | [App](https://segment-anything-webui.vercel.app/)　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 | [Code](https://github.com/Kingfish404/segment-anything-webui/)                | -           | A web interface for the SAM.                                                                        |
...
| Anything 3D Novel View | ![img](https://github.com/Anything-of-anything/Anything-3D/raw/main/novel-view/assets/1.jpeg)| - | [Code](https://github.com/Anything-of-anything/Anything-3D) | - | SAM + [Zero 1-to-3](https://github.com/cvlab-columbia/zero123).|
| Any 3D Face | ![img](https://github.com/Anything-of-anything/Anything-3D/raw/main/AnyFace3D/assets/celebrity_selfie/mask_2.jpg)![img](https://github.com/Anything-of-anything/Anything-3D/raw/main/AnyFace3D/assets/celebrity_selfie/2.gif)| - | [Code](https://github.com/Anything-of-anything/Anything-3D) | - | SAM + [HRN](https://younglbw.github.io/HRN-homepage/).|
